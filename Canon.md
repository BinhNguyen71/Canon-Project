...
Economic Integration is achieved from mainly from trade liberalisation. What we question here is to what extent does opening up the economy to foreign competition promote effective Economic Development.

From the stages of Economic Integration we focus our analysis on the the initial four: tariff preferences system, free trade are, customs union and the common market as a consolidation.
...
Under the empirical evidences of trade liberalisation we address to the case of the Pacific Arch. A process which in which we can distinguish 3 different phases:
	...
	- The 2nd Generation of Industrialised countries (Thailand, Malasya, Indonesia and China)

The mentioned region were not exactly wealthy nor in resources and capital. Nevertheless the labor is abundant, disciplined, capable and rather cheap.
